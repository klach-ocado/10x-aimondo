# AI Rules for AImondo

AImondo is a web application that allows users to update their workouts in a GPX format and visualize them on a map, especially in a heatmap style.
